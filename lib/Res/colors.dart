...
const primaryColor = Color(0xFF1872c5);
Color appPrimaryColor = primaryColor;

// const appSecondaryColor = Color(0xFFF68685);
const appSecondaryColor = Color(0xFFFD5722);
const primaryDarkColor = Color.fromRGBO(10, 9, 9, 1);

const appBackgroundColor = Color(0xFFF9F9F9);

const titleFontColor = Color(0xFF222222);
const darkBlackFontColor = Color(0xFF222222);
const redFontColor = Colors.red;
...
const textPrimaryLightColor = Color(0xFFCACACA);
const textSecondaryLightColor = Color(0xFFCACACA);
